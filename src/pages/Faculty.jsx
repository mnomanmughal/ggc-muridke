  ...
  const facultyMembers = [
    {
      ...
      designation: isUrdu ? 'ایسوسی ایٹ پروفیسر' : 'Assitant Professor | Principal',
    ...
    { image: "/images/MYaqoob.png",
      ...
      designation: isUrdu ? 'پروفیسر' : 'Assitant Professor | Vice Principal',
      subject: isUrdu ? 'کیمسٹری' : 'Urdu',
      qualification: 'M.Phil Urdu',
      email: '',
      department: 'Arts',
    },
    { image: "/images/akmal.jpeg",
    ...
    { image: "/images/Ashaq.png",
      ...
      designation: isUrdu ? 'لیکچرر' : 'Assitant Professor',
    ...
    { image: "/images/Sakhwat.png",
      ...
      designation: isUrdu ? 'ایسوسی ایٹ پروفیسر' : 'Assitant Professor',
    ...
    { image: "/images/riaz.jpeg",
      name: isUrdu ? 'محمد اکرم' : 'Dr. Mian Riaz Ali',
    ...
    { image: "/images/umer.jpeg",
      name: isUrdu ? 'رابعہ خان' : 'Muhammad Umar',
      designation: isUrdu ? 'لیکچرر' : 'Lecturer',
